...
object MyConfiguration {
    ...
    def askDevConfig(): Config = {
        //Uncomment the following 1 line for Hamachi (OWN Hamachi IP address)
        //val ipRaw = Array(25,37,4,113)

        //Uncomment the following 1 line for running locally
        val ipRaw = Array(127,0,0,1)
    ...
    def apply(extHostName: String, intHostName: String, port: String): Config = {
        ...
        s"""
            ...
            |      "monopoly.protocol.JsonSerializable" = jackson-json
            |    }
            |  }
            |  remote {
            |    artery {
